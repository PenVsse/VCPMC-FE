...
import TableDataHDKT, { IHopDongKT } from "./TableDataHDKT";
import { hopDongKTApi } from "../../../api/hongdongKTApi";
...
const HopDong: React.FC = () => {
  ...
  const [hopdongKTs, setHopdongKTs] = useState<IHopDongKT[]>([]);
  ...
  useEffect(() => {
    ...
    hopDongKTApi
      .getAll()
      .then((res) => res.data)
      .then((data) => setHopdongKTs(data.data));
  }, []);
